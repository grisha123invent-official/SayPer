...
3. **Перетащи скачанный файл из Finder прямо в окно Терминала.** Полный путь подставится сам — неважно, где файл лежит и как называется. В этом весь смысл перетаскивания: если скачал дважды, вторая копия называется `SayPer-1.0 2.dmg`, и набирать такое руками — верный способ ошибиться.
4. Нажми **Enter**.
